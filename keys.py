...
class KeyConfigPanel(Dialog):
    ...
    def key_down(self, evt):
        ...
        if self.keyConfigTable.rows.cell_to_item_no(0, 0) + self.keyConfigTable.rows.num_rows() - 1 > self.selectedKeyIndex or self.keyConfigTable.rows.cell_to_item_no(0,
                                                                                                                                                                        0) + self.keyConfigTable.rows.num_rows() - 1 < self.selectedKeyIndex:
